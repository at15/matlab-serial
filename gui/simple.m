...
% Last Modified by GUIDE v2.5 10-Jun-2016 16:31:18
...
try
    ...
    str = char(out');
    disp(str);
    % show on edit control
     set(handles.text_read, 'string', str);
catch ex
    disp(ex.message);
end
...
function text_read_Callback(hObject, eventdata, handles)
% hObject    handle to text_read (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of text_read as text
%        str2double(get(hObject,'String')) returns contents of text_read as a double


% --- Executes during object creation, after setting all properties.
function text_read_CreateFcn(hObject, eventdata, handles)
% hObject    handle to text_read (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
